...
/*   Updated: 2024/04/25 18:27:33 by makoch-l         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	my_mlx_pixel_put(&img, 14, 5, 0x00FF0000);
	my_mlx_pixel_put(&img, 16, 5, 0x00FF0000);
	my_mlx_pixel_put(&img, 18, 5, 0x00FF0000);
